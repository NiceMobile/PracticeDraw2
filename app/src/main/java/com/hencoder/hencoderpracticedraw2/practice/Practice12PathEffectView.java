...
public class Practice12PathEffectView extends View {
...

    {
        ...
        path1.rLineTo(20f, 20f);
        path1.rLineTo(-40f, 0f);
        path1.close();
        pathDashPathEffect = new PathDashPathEffect(path1, 25, 0, PathDashPathEffect.Style.TRANSLATE);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第五处：SumPathEffect
        PathEffect effect = new DashPathEffect(new float[]{20, 10}, 0);
        ...
        paint.setPathEffect(new ComposePathEffect(effect, effect1));
        canvas.drawPath(path, paint);
        canvas.restore();
    }
}
